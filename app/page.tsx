      ...
      <section id="faq" className="py-24 px-6 border-t border-border">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="space-y-3">
            {[
              { q: 'How is this different from Procore or Autodesk?', a: "Those tools manage project execution. We connect execution → billing → compliance → intelligence." },
              { q: 'Do I need to replace my ERP?', a: 'No. SYNLUMEX sits above your ERP. We connect the gaps between systems.' },
              { q: 'Is my data safe?', a: 'Yes. Multi-tenant architecture with database-level row-level security. Your projects are isolated.' },
              { q: 'How does the AI work?', a: 'Multiple providers (Groq, Cerebras, OpenRouter, Gemini) with automatic failover. Your data is never used for training.' },
              { q: 'Can I try before paying?', a: 'Yes — 14-day trial on Pro. No credit card required.' },
              { q: 'Do you offer custom deployments?', a: 'Yes. Enterprise plan includes SSO, custom SLAs, dedicated support, and optional on-prem.' }
            ].map((item, i) => (
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                <li>
                  <a href="https://wa.me/919999999999" target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-foreground flex items-center gap-2">
