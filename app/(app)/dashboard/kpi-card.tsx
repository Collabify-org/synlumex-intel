...
export function KpiCard({ icon: Icon, label, value, sub, trend, className, accent }: Props) {
  ...
  return (
    ...
    >
      {accent && <div className="absolute inset-0 bg-gradient-to-br from-brand/5 to-transparent pointer-events-none" />}
      ...
      <div className="relative">
        ...
        <div className={cn('font-semibold tracking-tight', accent ? 'text-3xl text-brand' : 'text-2xl')}>
          {value}
        </div>
