...
import {
  ...
  Building2, HardHat, Factory, Truck, Eye, MessageCircle, Play,
            ...
            {[
              {
                ...
                body: "Change orders sit in email. Approvals wait for signatures. Billing gets delayed. Nobody knows where work is stuck."
              },
              {
                icon: Banknote,
                title: "Margin dies invisibly",
                body: "You know what you billed. You don't know what's stuck between execution and collection. Unbilled revenue is invisible."
              },
              {
                icon: Brain,
                title: "Knowledge walks away",
                body: "When your best project manager leaves, the process leaves with them. Six months later, you repeat the same mistakes."
              }
            ].map((item, i) => (
            ...
            {[
              {
                ...
                body: "Structured lifecycle from requirements through 14 stages to closeout. Every stage has owners, gates, and evidence.",
                features: ["14-stage lifecycle", "BOQ intelligence", "AI extraction from PDF"]
              },
              {
                icon: TrendingUp,
                step: "02",
                title: "Execution to Money",
                body: "Progress, billing, and collection — all connected. See unbilled revenue, collection efficiency, and cash gaps in real time.",
                features: ["Commercial visibility", "Unbilled revenue tracking", "Risk scoring"]
              },
              {
                icon: Sparkles,
                step: "03",
                title: "Intelligence Layer",
                body: "Every mutation triggers recompute. Exceptions auto-created. Historical patterns compound. The system gets smarter over time.",
                features: ["Auto-flagged exceptions", "AI risk analysis", "Historical intelligence"]
              }
            ].map((item, i) => (
      ...
      <section className="py-24 px-6 bg-card/30 border-t border-border">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto mb-12">
            ...
            every update triggers recompute, exceptions, and remиnders automatically.
          </p>

          <div className="rounded-lg border border-border bg-background p-8 text-left font-mono text-xs">
            <div className="space-y-3">
              <div className="flex items-start gap-3">
                <div className="text-brand-cyan shrink-0">01 →</div>
                <div><span className="text-foreground font-semibold">Anyone updates</span> <span className="text-muted-foreground">— site engineer marks progress, finance records billing, PM changes stage</span></div>
              </div>
              <div className="flex items-start gap-3">
                <div className="text-brand-cyan shrink-0">02 →</div>
                <div><span className="text-foreground font-semibold">System recomputes</span> <span className="text-muted-foreground">— project health recalculated against rules</span></div>
              </div>
              <div className="flex items-start gap-3">
                <div className="text-brand-cyan shrink-0">03 →</div>
                <div><span className="text-foreground font-semibold">Exceptions auto-created</span> <span className="text-muted-foreground">— delayed, overrun, missing evidence, collection gap</span></div>
              </div>
              <div className="flex items-start gap-3">
                <div className="text-brand-cyan shrink-0">04 →</div>
                <div><span className="text-foreground font-semibold">Owners notified</span> <span className="text-muted-foreground">— reminder to the person accountable</span></div>
              </div>
              <div className="flex items-start gap-3">
                <div className="text-brand-cyan shrink-0">05 →</div>
                <div><span className="text-foreground font-semibold">Audit logged</span> <span className="text-muted-foreground">— immutable record of every action and impact</span></div>
              </div>
              <div className="flex items-start gap-3">
                <div className="text-brand-cyan shrink-0">06 →</div>
                <div><span className="text-foreground font-semibold">Intelligence compounds</span> <span className="text-muted-foreground">— patterns feed back into the next project</span></div>
              </div>
            </div>
          </div>
        </div>
      ...
      <section id="industries" className="py-24 px-6 border-t border-border">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              If your business runs on projects with milestones, billing, and compliance —
              SYNLUMEX adapts.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              ...
              },
              {
                name: "Pro",
                price: "₹14,999",
                tagline: "For growing EPC contractors",
              ...
              },
              {
                name: "Enterprise",
                price: "₹49,999",
                tagline: "For large portfolio owners",
              ...
              >
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className={`block w-full rounded-md px-4 py-2.5 text-sm font-medium text-center transition-opacity ${
                    tier.highlight
          ...
          <div className="space-y-3">
            {[
              ...
              <details key={i} className="group rounded-lg border border-border bg-card/50 overflow-hidden">
                <summary className="cursor-pointer p-4 font-medium text-sm flex items-center justify-between hover:bg-accent/30 transition-colors">
                  {item.q}
      ...
      <section className="py-24 px-6 border-t border-border relative overflow-hidden">
        ...
        <div className="max-w-3xl mx-auto text-center relative">
          ...
          <p className="text-muted-foreground mb-8 max-w-xl mx-auto">
            15-minute walkthrough. No sales pitch. See your own workflows mapped
            onto SYNLUMEX in real time.
          </p>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                <li><a href="mailto:support@synlumex.ai" className="text-muted-foreground hover:text-foreground transition-colors">Contact</a></li>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                ...
                <li>
                  <a href="mailto:support@synlumex.ai" className="text-muted-foreground hover:text-foreground transition-colors">
                    support@synlumex.ai
                  </a>
                </li>
              </ul>
          ...
          <div className="pt-8 border-t border-border flex flex-col md:flex-row items-center justify-between gap-3">
            <div className="text-xs text-muted-foreground font-mono">
              © 2026 SYNLUMEX INTEL · All rights reserved
            </div>
